##############################################################################################
# PPTX Quiz Maker:
# This is a program that takes a PPTX and allows the user to indicate which
#section(s) they deem important by using "<@" and "@>" in the PPTX which this 
#program will then extract and create fill-in-the-blank questions. The blanks
#can either be randomized or customized by using "<!" and "!>" in the PPTX.
...
def upload(name_of_file):
  ''' (str) -> obj
  Descrip: The name of the PPTX file is inputted to this function and is used to 
  upload the PPTX to the program
...
def text_extracter(prs):
  ''' (obj) -> dict
  Descrip: Given the PPTX object, this function goes through each shape in the 
...
#The user needs to type in the pptx file in the following line
...
#file_name = input("What is the name of your pptx file?\n")
